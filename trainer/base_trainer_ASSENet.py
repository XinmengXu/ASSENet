...
class BaseTrainer:
    def __init__(self,
        ...
        self.model.load_state_dict(load_checkpoint("C:\\Users\\Administrator\\Desktop\\Wave-U-Net-for-Speech-Enhancement-master\\Wave-U-Net-for-Speech-Enhancement-master\\checkpoints\\latest_model.tar", self.device))
        if self.n_gpu > 1:
    ...
    def _save_checkpoint(self, epoch, is_best=False):
        ...
        """
        torch.save(state_dict, ("C:\\Users\\Administrator\\Desktop\\Wave-U-Net-for-Speech-Enhancement-master\\Wave-U-Net-for-Speech-Enhancement-master\\checkpoints\\latest_model_final.tar").as_posix())
        ...
        if is_best:
            ...
            torch.save(state_dict, "C:\\Users\\Administrator\\Desktop\\Wave-U-Net-for-Speech-Enhancement-master\\Wave-U-Net-for-Speech-Enhancement-master\\checkpoints\\best_model_final.tar")
